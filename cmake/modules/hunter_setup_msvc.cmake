...
macro(hunter_setup_msvc)
  if(MSVC AND NOT HUNTER_MSVC_ARCH)
    ...
    string(REGEX MATCH "^19[34][0-9]$" _vs_17_2022_1 "${MSVC_VERSION}")
    string(REGEX MATCH "^193[0-9]$" _vs_17_2022_2 "${MSVC_VERSION}")
    string(REGEX MATCH "^194[0-4]$" _vs_17_2022_3 "${MSVC_VERSION}")
    ...
    elseif(_vs_17_2022_1 OR _vs_17_2022_2 OR _vs_17_2022_3 )
