...
function(hunter_upload_cache KEEP_PACKAGE_BUILD_DIR)
  ...
  if(empty_server)
    ...
    if(KEEP_PACKAGE_BUILD_DIR)
      hunter_status_debug("Proctecting ${HUNTER_PACKAGE_DEBUG} from hunter_upload_cache")
    else()
      hunter_status_debug("Deleting ${HUNTER_PACKAGE_DEBUG}")
