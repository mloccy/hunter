...
hunter_default_version(Clang VERSION 18.1.8)
...
hunter_default_version(LLVM VERSION 18.1.8) # Clang
...
hunter_default_version(NASM VERSION 2.15.03)
...
hunter_default_version(OpenSSL VERSION 3.5.0)
...
hunter_default_version(Qt6 VERSION 6.10.1)
...
hunter_default_version(SDL3 VERSION v3.3.6-p1)
...
hunter_default_version(SPIRV-Headers VERSION 1.4.313.0)
...
hunter_default_version(VUL VERSION 1.4.315-p0)
hunter_default_version(VVL VERSION 1.4.315-p1)
hunter_default_version(Vulkan-Headers VERSION 1.4.315-p0)
hunter_default_version(Vulkan-Loader VERSION v1.4.307-p2)
hunter_default_version(Vulkan-Tools VERSION 1.4.313)
...
hunter_default_version(ZLIB VERSION 1.3.0-p1)
...
hunter_default_version(autoconf-archive VERSION 2024.10.16-p0)
...
hunter_default_version(bison VERSION 3.8.2-p0)
hunter_default_version(blake3 VERSION 1.8.2)
...
hunter_default_version(directx-headers VERSION 1.616.0)
...
hunter_default_version(drm VERSION 2.4.125)
...
if (WIN32)
  hunter_default_version(flex VERSION 2.5.25)
else()
...
hunter_default_version(gettext VERSION 0.26-1)
...
if (NOT WIN32)
  ...
  hunter_default_version(glib VERSION 2.28.8-1)
endif()
...
hunter_default_version(glslang VERSION 15.3.0-p1)
...
hunter_default_version(ispc VERSION 1.29.1)
...
if (UNIX)
  hunter_default_version(libffi VERSION 3.3.0)
else()
  hunter_default_version(libffi VERSION 3.2.1)
endif()
hunter_default_version(libglvnd VERSION 1.7.0-p0)
...
hunter_default_version(libressl VERSION 4.1.0)
...
hunter_default_version(libxml2 VERSION 2.14.5)
...
hunter_default_version(m4-win32 VERSION 1.4.14-1)
hunter_default_version(magnum VERSION 2019.01)
hunter_default_version(md5 VERSION 1.6)
hunter_default_version(mesa VERSION 25.0.6-p0)
...
hunter_default_version(ninja-build VERSION 1.13.1)
...
hunter_default_version(nuklear VERSION 1.0.0-p1)
...
hunter_default_version(pip_mako VERSION 1.3.7)
hunter_default_version(pip_markupsafe VERSION 3.0.2)
hunter_default_version(pip_meson VERSION 1.8.0-p0)
...
hunter_default_version(pip_pyyaml VERSION 6.0.2)
...
hunter_default_version(python VERSION 3.9.17)
...
hunter_default_version(regex2-win32 VERSION 1.4.14-1)
...
hunter_default_version(spirv-reflect VERSION 1.4.335.0-p0)
...
hunter_default_version(valijson VERSION 1.0.6)
...
hunter_default_version(wayland VERSION 1.24.0)
hunter_default_version(wayland-protocols VERSION 1.41.0)
...
hunter_default_version(x11 VERSION 1.8.12)
...
hunter_default_version(xcb VERSION 1.17)
hunter_default_version(xcb-proto VERSION 1.17.0)
